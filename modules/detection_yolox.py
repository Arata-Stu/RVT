...
from data.utils.types import DataType, ObjDetOutput, DatasetSamplingMode
from models.detection.yolox.utils.boxes import postprocess
from models.detection.yolox_extension.models.yolox_detector import YOLOX
...
class ModuleYOLOX(pl.LightningModule):
    def __init__(self, full_config: DictConfig):
        ...
        self.mdl = YOLOX(self.mdl_config)
